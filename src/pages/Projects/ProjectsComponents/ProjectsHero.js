    ...
    <section style={styles.heroSection}>
      ...
      <div style={styles.container}>
        ...
        >
          ...
          >
            Discover our portfolio of innovative solutions that have transformed businesses and delivered 
            exceptional results across various industries and platforms.
          </motion.p>
        </motion.div>
        ...
        >
          <div style={styles.codeEditor}>
            <div style={styles.editorHeader}>
              ...
              <div style={styles.editorTitle}>projects.jpg</div>
            </div>
            
            <div style={styles.imageContent}>
              <img 
                src="https://images.unsplash.com/photo-1512486130939-2c4f79935e4f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" 
                alt="Dlams Software Projects" 
                style={styles.projectsImage}
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80";
                }}
              />
              <div style={styles.imageOverlay}>
                <span style={styles.overlayText}>Project Portfolio</span>
              </div>
            </div>
            ...
            <div style={styles.terminalOutput}>
              ...
              >
                <span style={{color: '#4ADE80'}}>✓</span> E-commerce • SaaS • Mobile Apps
              </motion.div>
            </div>
          </div>
        </motion.div>
