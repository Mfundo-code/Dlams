...
export default function AboutCompany() {
  ...
  // Updated stats for Dlams Software Solutions
  const stats = [
  ...
  useEffect(() => {
    ...
    // Tech symbols for software company
    const techSymbols = ['⚡', '🚀', '💻', '🔒', '🔧', '📱', '💼', '🏆', '✨', '🌟', '🔗', '🌐'];
    ...
    class Node {
      constructor(x, y) {
        ...
        // Dlams color scheme - gold (#FFD700) and blue (#1E3A8A) themes
        this.hue = Math.random() > 0.5 ? 50 : 220; // 50 for gold/yellow, 220 for blue
      }
    ...
    class Connection {
      ...
      draw() {
        ...
        // Create gradient along the connection using Dlams colors
        const gradient = ctx.createLinearGradient(
          this.node1.x, this.node1.y,
          this.node2.x, this.node2.y
        );
        gradient.addColorStop(0, `hsla(50, 85%, 50%, ${alpha * 0.3})`); // Gold
        gradient.addColorStop(0.5, `hsla(220, 70%, 50%, ${alpha * 0.5})`); // Blue
        gradient.addColorStop(1, `hsla(50, 85%, 50%, ${alpha * 0.3})`); // Gold
    ...
    const animate = () => {
      ...
      // Draw subtle background grid with Dlams gold color
      ctx.strokeStyle = 'rgba(255, 215, 0, 0.03)'; // Gold color
      ctx.lineWidth = 0.5;
      const gridSize = 40;
      ...
      <div style={styles.container}>
        <div style={styles.content}>
          ...
          >
            ...
            >
              About Dlams Software Solutions
            </motion.h2>
            ...
            >
              At Dlams Software Solutions, we transform businesses through innovative digital solutions. 
              We specialize in creating custom software, mobile applications, e-commerce platforms, 
              and enterprise solutions that drive growth and enhance digital presence. Our team of 
              expert developers is dedicated to delivering excellence in every project.
            </motion.p>
