    ...
    <section style={styles.heroSection}>
      ...
      <div style={styles.container}>
        ...
        >
          ...
          >
            Join our innovative team and grow your career in a dynamic environment where 
            creativity meets technology. We're looking for passionate individuals to shape the future.
          </motion.p>
        </motion.div>

        {/* Updated Image container with same structure as others */}
        <motion.div 
        ...
        >
          <div style={styles.codeEditor}>
            <div style={styles.editorHeader}>
              ...
              <div style={styles.editorTitle}>careers.jpg</div>
            </div>
            ...
            <div style={styles.imageContent}>
              <img 
                ...
                alt="Dlams Software Careers" 
                style={styles.careersImage}
                onError={(e) => {
                  e.target.onerror = null;
                  e.target.src = "https://images.unsplash.com/photo-1521791136064-7986c2920216?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80";
                }}
              />
              <div style={styles.imageOverlay}>
                <span style={styles.overlayText}>Join Our Team</span>
              </div>
            </div>
            ...
            <div style={styles.terminalOutput}>
              ...
              >
                <span style={{color: '#4ADE80'}}>✓</span> Tech • Design • Marketing • More
              </motion.div>
            </div>
          </div>
        </motion.div>
