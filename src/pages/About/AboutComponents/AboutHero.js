    ...
    <section style={styles.heroSection}>
      ...
      <div style={styles.container}>
        ...
        >
          ...
          >
            We transform visionary ideas into powerful digital solutions. Our journey is built on 
            innovation, precision engineering, and a relentless pursuit of excellence in every line of code.
          </motion.p>
        </motion.div>
        ...
        >
          <div style={styles.codeEditor}>
            <div style={styles.editorHeader}>
              ...
              <div style={styles.editorTitle}>about.jpg</div>
            </div>
            
            <div style={styles.imageContent}>
              <img 
                src="https://images.unsplash.com/photo-1552664730-d307ca884978?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1000&q=80" 
                alt="Dlams Software Solutions Team" 
              ...
              <div style={styles.imageOverlay}>
                <span style={styles.overlayText}>Innovation & Excellence</span>
              </div>
            </div>
            ...
            <div style={styles.terminalOutput}>
              ...
              >
                <span style={{color: '#4ADE80'}}>✓</span> Crafting digital solutions since 2020
              </motion.div>
            </div>
          </div>
        </motion.div>
