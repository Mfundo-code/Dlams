...
const Footer = () => {
  ...
  const servicesList = [
    { name: "Digital Presence Package", path: "/services/digital-presence" },
  ...
  const socialLinks = [
    {
      name: "Instagram",
      url: "https://www.instagram.com/dlamsoft",
      icon: (
          ...
          <div style={styles.linksColumn}>
            ...
            <nav style={styles.linksList}>
              {servicesList.map((service, idx) => (
                <motion.a key={service.name} href={service.path} style={styles.plainLink} whileHover={{ x: 5, color: GOLD }} whileTap={{ scale: 0.98 }} initial={{ opacity: 0, x: -10 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.4, delay: idx * 0.1 }}>
